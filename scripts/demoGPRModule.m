...
% Mdl2 - optimized modle generated by the same configuration as for Mdl1
% Mdl3 - optimized modle generated by the same configuration as for Mdl1 with
%        free tuning of variance
...
% [fang3, frad3, fcos3, fsin3, fcov3, s3, ciang3, cirad3] = predDS(Mdl3, TestDS);
...
% [AAED3, SLLA3, SLLR3, SEA3, SER3, SEC3, SES3] = lossDS(Mdl3, TestDS);
