...
projectDocFiles = { ...
    ...
    fullfile(rootPath, 'scripts', 'Executable_Scripts.m'), ...
};
...
%  Remove autogenerated directory helpsearch-v3
disp('Remove old search entries ...');
removeStatus = rmdir(fullfile(rootPath, 'docs', 'html', 'helpsearch-v3'), 's');
if removeStatus
