...
clc;
disp('Start kernel parameter investigation ...');
clearvars;
%close all;
...
function sweepKernelWithConstNoise(Mdl, nEval, titleStr, PathVariables)
    ...
    stStr = "$\sigma_f^2,\sigma_l|\sigma_n^2 = " + ...
        "\arg\min\tilde{R}_\mathcal{L}" + ...
        "(\sigma_f^2,\sigma_l|\sigma_n^2)$ f. $\sigma_n^2 = const.$";
    subtitle(stStr);
    legend([p1, p2, p3], ...
        {"Parameter Bounds", "Search Area", ...
         sprintf("fmincon $\\tilde{R}_\\mathcal{L}(%1.2f,%1.2f|%1.2e)=%1.2f$",...
    ...
    cbStr = "$\tilde{R}_\mathcal{L}(\sigma_f^2,\sigma_l|\sigma_n^2)$";
