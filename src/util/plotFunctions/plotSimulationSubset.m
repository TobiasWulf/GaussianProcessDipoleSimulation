...
%     cb1.Label.FontSize = 12;
    ...
    title(sprintf('$V_{cos}$ of Enabled Array Positions over $\\theta$, $V_{cc} = %.1f$ V, $V_{off} = %.2f$ V', Vcc, Voff), ...
        'FontWeight', 'normal', ...
        'FontSize', 12, ...
        'FontName', 'Times', ...
        'Interpreter', 'latex');
    ...
    title(sprintf('$V_{sin}$ of Enabled Array Positions over $\\theta$, $V_{cc} = %.1f$ V, $V_{off} = %.2f$ V', Vcc, Voff), ...
        'FontWeight', 'normal', ...
        'FontSize', 12, ...
        'FontName', 'Times', ...
        'Interpreter', 'latex');
