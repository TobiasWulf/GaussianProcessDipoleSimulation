...
% cosinus and sinus output voltages by representing one maximum and minimun in
% the characterization fields. So circular path on the charctiration fields
...
% is used in sesnor array simulation. It is not needed to drive the sensor in
% saturation.
%
% <html>
