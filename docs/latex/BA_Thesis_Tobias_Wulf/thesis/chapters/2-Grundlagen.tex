...
%der Gebermagnetfeldstärke $\vec{H}$ und setzt diese in elektrische Spannungssignale um. Bedingt durch die 
%Kreisbewegung 
...
%Quadrates zwischen den Punkten $A$ und $B$. Entsprechend der Kreisbahnnormierung für die Messpunkte, ist diese Form 
%der 
%Abstandsermittlung als euklidischer Abstand $d_E\langle A,B \rangle$ bezeichnet. Zu berechnen ist der Abstand 
%$d_E\langle A,B \rangle$ nach \autoref{eq:euklidischerabstand} als Vektor-2-Norm der vektoriellen Differenz von $A$ 
%und 
%$B$.
