...
Grundlage von Charakterisierungsdatensätzen. Hierfür wird ein einzelner Sensor-IC, z.B. der TMR-Sensor TAS2141-AAAB der 
...
dargestellt. Es wird ein Simulationsmodell aufgebaut, das Charakterisierungsdatensätze verarbeiten kann und 
entsprechende Charakteristiken eines einzelnen Sensor-IC zu einem Sensor-Array interpoliert. Abhängig von weiteren 
gewählten Eigenschaften des Sensor-Arrays, wie geometrische Anordnung und Größe, produziert das interpolierte Modell 
Simulationsdatensätze, die das Verhalten des einzelnen Sensor-IC ortsabhängig im Sensor-Array abbilden.
\newline
...
eines modernen, vollwertigen Sensor-IC. Seine Aufgabe besteht darin, eine physikalische Anregung (Magnetfeld) in 
elektrische, analoge Signale umzuwandeln. Dieser Teil eines Sensor-IC wird zumeist als \gls{gl:sensorkopf} bezeichnet, 
da eine sinnbildliche darunterliegende Einheit die weitere Signalverarbeitung und -Auswertung übernimmt. Es handelt 
...
\begin{figure}[tbph]
	...
	\caption[Veranschaulichung eines vollständigen Sensor-IC für die Drehwinkelerfassung]{Veranschaulichung eines 
