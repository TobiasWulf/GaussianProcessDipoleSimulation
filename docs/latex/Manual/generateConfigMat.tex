...
\setlength{\itemsep}{-1ex}
   ...
   \item See Also
   \item Clean Up
   \item Default Plot Settings
   \item GeneralOptions
   \item Path Variables
   \item Publish Options
   \item Sensor Array Options
   \item Dipole Options
   \item Traning Options
   \item Test Options
   \item GPR Options
...
\subsection*{Default Plot Settings}
...
\subsection*{Sensor Array Options}
