...
\begin{par}
Util function and classes to provide reuse for often upcommings tasks and functionality besides project kernel and module source code. Located under source code directory: \textbf{./src/util}.
\end{par} \vspace{1em}
\begin{par}
