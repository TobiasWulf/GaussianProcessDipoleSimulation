...
\begin{par}
\textbf{plotKMZ60CharDataset()} explores the dataset and plot its content in three docked figure windows. Loads dataset location from config.mat.
\end{par} \vspace{1em}
