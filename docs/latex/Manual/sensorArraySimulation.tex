...
\setlength{\itemsep}{-1ex}
   \item See Also
   \item simulateDipoleSquareSenorArray
   \item computeDipoleHField
   \item computeDipoleH0Norm
   \item generateSensorArraySquareGrid
   \item generateDipoleRotationMoments
   \item rotate3DVector
\end{itemize}
...
\subsection*{simulateDipoleSquareSenorArray}
...
\subsection*{computeDipoleHField}
...
\subsection*{computeDipoleH0Norm}
...
\subsection*{generateSensorArraySquareGrid}
...
\subsection*{generateDipoleRotationMoments}
