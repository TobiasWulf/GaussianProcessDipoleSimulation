function [ MAGNET ] = currentDrivenCircles2( radian, nr_points, mulMAG , flagRot)
...
% date   :      11.01.2017  -> changed circle computation
%               30.08.2016  -> implementation
%==========================================================================
...
for k = 1 : length(mulMAG.x)
        if mulMAG.pn(k) == 0 
            % positive direction 
            for t = 0:2*pi/(nr_points):2*pi-2*pi/(nr_points)
                ...
                %==========================================================
                % new code: Set the next step of the circle for the 
                % computation
                a = a+1; 
                MAGNET.normal.xt(a) = radian*cos(t+1e-12);
                MAGNET.normal.yt(a) = radian*sin(t+1e-12);
                MAGNET.normal.zt(a) = 0;
            ...
            a = a+1;
             ...
             % negative direction 
            for t = 2*pi:-2*pi/(nr_points):0+2*pi/(nr_points)
                MAGNET.normal.xt(a) = radian*cos(t);
                MAGNET.normal.yt(a) = radian*sin(t);
                MAGNET.normal.zt(a) = 0;
